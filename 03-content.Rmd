...
**DiagrammeR** provides methods to build graphs for a number of different graphing languages. We will present a Graphviz example in this section,[^1] but you can also use pure R code to create graphs and diagrams with **DiagrammeR**.

[^1]: Depending on your background, this section may be a biased introduction to **DiagrammeR**. Please see its official documentation if you are interested in this package.
