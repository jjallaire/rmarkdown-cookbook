...
2.  Enable caching for at least one code chunk (see Section \@ref(cache)). When caching is enabled, R Markdown will not delete the plot folder.
...
2.  Add `Suggests: knitr, rmarkdown` in `DESCRIPTION`.
